...
cnn = load_model(r'C:\Users\Admin\Music\FRONTEND\new_project\Alzheimer_cnn_2.h5')
vgg16 = load_model(r'C:\Users\Admin\Music\FRONTEND\new_project\Alzheimer_vgg16.h5')
...
def predict(img,algo): 
	...
	#res = img_array.reshape(-1, 224, 224, 1)
	print(res.shape)
	if algo=='cnn':
